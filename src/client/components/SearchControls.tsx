  ...
  return (
    <div className="glass-panel rounded-2xl p-5 shadow-xl">
      ...
      <form
        ...
        className="mt-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-start"
      >
        {/* Person Selector */}
        <div className="md:col-span-5 flex flex-col">
          <label
            htmlFor="person-select"
            className="text-xs font-medium text-slate-300 mb-1.5 flex items-center gap-1.5 h-4"
          >
            ...
            {selectedPerson && selectedPerson.latestRole ? (
              <div className="flex items-center gap-1.5 text-xs text-slate-400 flex-wrap">
                <span className="text-slate-300 font-medium">
                  {selectedPerson.latestRole.company}
                </span>
              ...
              <span className="text-[11px] text-slate-500">
                Starting point for warm referral paths
              </span>
            )}
          </div>
        </div>
        ...
        <div className="md:col-span-3 flex flex-col">
          <div
            className="text-xs font-medium text-transparent mb-1.5 select-none hidden md:flex items-center gap-1.5 h-4"
            aria-hidden="true"
          >
            <span>&nbsp;</span>
          </div>
          ...
          <div
            className="mt-1.5 min-h-[20px] hidden md:block"
            aria-hidden="true"
          />
        </div>
      </form>
